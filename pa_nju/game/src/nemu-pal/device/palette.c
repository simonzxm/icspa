...
--*/
{
    ...
    for (i = 0; i < 32; i++) {
        ...
        for (j = 0; j < 256; j++) {
            t[j].r = (BYTE)(((INT)(palette[j].r) * (31 - i) +
                             (INT)(newpalette[j].r) * i) /
                            31);
            t[j].g = (BYTE)(((INT)(palette[j].g) * (31 - i) +
                             (INT)(newpalette[j].g) * i) /
                            31);
            t[j].b = (BYTE)(((INT)(palette[j].b) * (31 - i) +
                             (INT)(newpalette[j].b) * i) /
                            31);
        }
        VIDEO_SetPalette(t);
...
--*/
{
    ...
    for (i = 0; i < 32; i++) {
        for (j = 0; j < 256; j++) {
            ...
            color =
                ((INT)palette[j].r + (INT)palette[j].g + (INT)palette[j].b) /
                    4 +
                64;
