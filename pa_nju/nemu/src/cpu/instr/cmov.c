...
make_instr_impl_2op_cc(cmov, rm, r, v, a) make_instr_impl_2op_cc(cmov, rm, r, v,
                                                                 ae)
    make_instr_impl_2op_cc(cmov, rm, r, v, b) make_instr_impl_2op_cc(cmov, rm,
                                                                     r, v, be)
        make_instr_impl_2op_cc(cmov, rm, r, v,
                               g) make_instr_impl_2op_cc(cmov, rm, r, v, ge)
            make_instr_impl_2op_cc(cmov, rm, r, v,
                                   l) make_instr_impl_2op_cc(cmov, rm, r, v, le)
                            ...
                            make_instr_impl_2op_cc(cmov, rm, r, v, ns)
                                make_instr_impl_2op_cc(cmov, rm, r, v, o)
                                    make_instr_impl_2op_cc(cmov, rm, r, v, p)
                                        make_instr_impl_2op_cc(cmov, rm, r, v,
                                                               s)
                                            make_instr_impl_2op_cc(cmov, rm, r,
                                                                   v, e)
